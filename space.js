    ...
    planetBtn.forEach(function (btn) {
      btn.addEventListener("click", function (e) {
        ...
        for (var i = 0; i < dest.length; i++) {
          if (dest[i].name === id) {
            distanceNumber === null || distanceNumber === void 0
              ? void 0
              : (distanceNumber.textContent = dest[i].distance);
            travelNumber === null || travelNumber === void 0
              ? void 0
              : (travelNumber.textContent = dest[i].travel);
